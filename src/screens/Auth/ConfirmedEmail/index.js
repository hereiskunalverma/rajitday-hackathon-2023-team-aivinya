...
const ConfirmedEmail = () => {
  ...
  const seoData = {
    title: 'AIvinya -  Email Confirmed Page',
    description: 'AIvinya -  Email Confirmed Page'
  };
  ...
  return (
    <React.Fragment>
      ...
      <Wrapper>
        ...
        <Title>
          Hooray 💫 Let's set up your <span className="text-ot-blue">WorkSpace </span>
        </Title>
        <Spin tip="Please wait while we setup your account..." spinning={loadingSpin}>
          <div>
            {isInviteFlow === 'true' ? (
              ...
              <div className="w-auto  rounded-lg border border-gray-200 shadow-md ">
                <a>
                  <img
                    className="rounded-t-lg"
                    src="https://s3.envato.com/files/225490645/Workplace590x332.jpg"
                    alt=""
                  />
                </a>
                <div className="p-5">
                  <a href="#">
                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 ">
                      Enter <span className="text-ot-blue"> Workspace name</span> & Hit{' '}
                      <span className="text-ot-blue">Enter</span>
                    </h5>
                  </a>
