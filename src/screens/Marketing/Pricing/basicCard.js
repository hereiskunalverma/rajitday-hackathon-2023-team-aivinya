...
const BasicCard = ({
  ...
  console.log(yearlyPrice, monthlyPrice);
  return (
          ...
          <div>
            ...
            {yearly && (
              <p className="text-gray-800 text-center">
                Billed
                {country ? '₹' + indianYearly : '$' + yearlyPrice}
                /year
              </p>
            )}

            {(yearly === '0' || monthlyPrice === '0') && (
              <p className="text-center text-xl font-bold text-ot-blue">Free Forever</p>
            )}
            {yearlyPrice !== '0' && yearly && (
              <p className="text-center text-sm font-bold text-ot-blue">Get Two Months free</p>
            )}
          </div>
        </CardHeader>
        <CardBody>
