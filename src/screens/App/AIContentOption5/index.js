...
const AIContentOption5 = () => {
  ...
  const getData = () => {
    ...
    axios
      .post(`${url}/api/get/aicontet/aiplagfree`, {
        text: inputText,
        tone: tone
      })
  ...
  return (
    <div className="h-screen p-3">
      ...
      <h1 style={{ fontSize: '1.2rem' }}>
        Want a Plagiarism free content ? I'll re-write it for you.
      </h1>
      <div className="bg-white p-3 w-1/3 rounded-full  outline-none ring-0 border  border-black/40 hover:border-blue-700 focus:border-blue-700 justify-evenly items-center justify-evenly">
        <Box sx={{ minWidth: 150 }}>
...
export default AIContentOption5;
